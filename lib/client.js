window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const tagId$3 = "dsh-better-api/ModelsSection.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId$3) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "dsh-better-api";
		...
		*/
		...
		/** Reasoning levels a profile may declare, in pi-ai's escalation order. */
		...
		*/
		function ModelListEditor(props) {
			...
			/** The model's declared reasoning levels, as a plain record. */
			const effortsOf = (model) => {
				const efforts = model["reasoningEfforts"];
				return typeof efforts === "object" && efforts !== null && !Array.isArray(efforts) ? efforts : {};
			};
			const effortChecked = (model, level) => Object.prototype.hasOwnProperty.call(effortsOf(model), level);
			/** Toggle one declared level; with no thinking level left, reasoning stays undeclared. */
			const toggleEffort = (index, level) => {
				const next = { ...effortsOf(models[index]) };
				if (Object.prototype.hasOwnProperty.call(next, level)) Reflect.deleteProperty(next, level);
				else next[level] = level === "off" ? null : level;
				if (!Object.keys(next).some((key) => key !== "off")) patch(index, { reasoningEfforts: void 0 });
						...
						children: [(0, react_jsx_runtime.jsxs)("div", {
							...
							children: [(0, react_jsx_runtime.jsxs)("label", {
								...
								children: [(0, react_jsx_runtime.jsx)("span", {
									...
									children: [(0, react_jsx_runtime.jsx)("span", {
										className: ModelsSection_module_css_default["modelFieldLabel"],
										children: t("modelReasoningEfforts")
									}), (0, react_jsx_runtime.jsx)("div", {
										style: {
											gap: "4px 12px",
											flexWrap: "wrap",
										...
										children: REASONING_LEVELS.map((level) => (0, react_jsx_runtime.jsxs)("label", {
											className: ModelsSection_module_css_default["candidateLabel"],
											children: [(0, react_jsx_runtime.jsx)("input", {
												type: "checkbox",
												checked: effortChecked(model, level),
												disabled,
												onChange: () => {
													toggleEffort(index, level);
												}
											}), (0, react_jsx_runtime.jsx)("span", {
												children: level
											})]
		...
		*/
		...
		const tagId$2 = "dsh-better-api/OnboardingModal.module.css";
		...
		*/
		...
		const tagId$1 = "dsh-better-api/DeepSeekOnboardingDialog.module.css";
		...
		*/
		...
		const tagId = "dsh-better-api/WelcomeNotice.module.css";
		...
		*/
		...
		const en = {
			...
			modelReasoningEfforts: "Reasoning strength",
